                  ...
                  highway will close the loop on focusing solely on the bottom line.</p> --}}
                        ...
                        <div class="info">
                            ...
                            <div class="item">
                                ...
                                <p>Insurances: <span>{{ $project->contractor->insurances }} <small>Verified</small></span>
                                </p>
                ...
                <div class="col-md-4">
                    <div class="right-side">
                        ...
                        <div class="enquire-box">
                            ...
                            <form action="{{ route('front.sendEnquiryMail') }}">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <input type="hidden" class="form-control" id="exampleInputPassword1" value="{{ Request::url() }}">
                                </div>
